package api.requests.common.FieldUtility;
...
public class FieldUtility extends base {

    public static void main(String[] args) {

        FieldUtility base = new FieldUtility();
    ...
    public Integer getFieldId(Recordset recordset) {
        {
            ...
            try {
                ...
                while (recordset.next()) {
                    ...
                    String update_sequence_file = builder.updateRequestObject("Fields/get_fields/get_fields_with_valid_token", pathParameter, queryParameter, header, body1);
                    JSONObject response = builder.performRequest(update_sequence_file);

                    ResponseValidator validator = new ResponseValidator(response);

                    fieldId = Integer.valueOf(validator.getDataFromBody("$.payload[0].id"));
