package api.requests.common.ApiUtility;
...
public class ApiUtility extends base {
    ...
    public static void main(String[] args) {
        ...
        ApiUtility base = new ApiUtility();
    ...
    public Integer getApiId(Recordset recordset) {
        {
            ...
            try {
                ...
                while (recordset.next()) {
                    ...
                    String update_sequence_file = builder.updateRequestObject("api_token/get_api_token/get_api_token", pathParameter, queryParameter, header, body1);
                    JSONObject response = builder.performRequest(update_sequence_file);

                    ResponseValidator validator = new ResponseValidator(response);

                    apiId = Integer.valueOf(validator.getDataFromBody("$.payload[0].id"));
