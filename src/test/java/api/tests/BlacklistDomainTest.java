...
//---------------------------------- GET THE TEST DATA FOR VALID TOKEN AND FREE PLAN TEST CASES --------------------------------------------//
    ...
    @DataProvider(name = "post_blacklist_domain_with_valid_token_free_plan")
    ...
    @Test(dataProvider = "post_blacklist_domain_with_valid_token_free_plan")
    public void post_blacklist_domain_with_valid_token_free_plan(String Token_Type, String Content_Type, String Subscription_State, String Plan, String Role1, String SHaccount1, String SHaccount2, String Ownership, String Role2, String Status_Code, String Schema) {
        ...
        logs.test_step("------------------------------------------ BLACKLIST DOMAIN ID TEST--------------------------------------------");
        String response = builder.updateRequestObject("blacklist_domain/post_blacklist_domain/post_blacklist_domain", pathParameter, queryParameters, header, body);
...
validator.validateSchema(Schema);}
    ...
    public Object[][] data_provider4() {
        DataReader reader = new DataReader();
        Object[][] data = null;
        data = reader.getExcelDataForDataProvider("blacklist_domain_test_case.xlsx", 4);
        return data;
    }
