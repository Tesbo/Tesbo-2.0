...
public class GetAgencyMetaTest extends base {

    @Test
    public void get_agency_meta_with_valid_data() {
        ...
        String update_file = builder.updateRequestObject("agency/get_agency_meta/get_agency_meta", pathParameter, queryParameters, header, body);
...
//        validator.validateSchemaFromRequestFile("agency/get_agency_config/get_agency_config");
    ...
    @Test
    public void get_agency_meta_with_invalid_token() {
    ...
    @Test
    public void get_agency_meta_with_blank_token() {
    ...
    @Test
    public void get_agency_meta_with_different_content_type() {
    ...
    @Test
    public void get_agency_meta_with_different_method() {
        ...
        String update_file = builder.updateRequestObject("agency/get_agency_meta/get_agency_meta_with_different_method", pathParameter, queryParameters, header, body);
        JSONObject response = builder.performRequest(update_file);
