...
public class SmtpImapConnectionTest extends base {


    //---------------------------------- GET THE TEST DATA FOR VALID TOKEN --------------------------------------------//

    @DataProvider(name = "smtp_imap_connection_with_valid_token")
    public Object[][] data_provider() {
        DataReader reader = new DataReader();
        Object[][] data = null;
        data = reader.getExcelDataForDataProvider("Smtp_Imap_Connection_Test_case.xlsx", 0);
        return data;
    }

    @Test(dataProvider = "smtp_imap_connection_with_valid_token")
    public void smtp_imap_connection_with_valid_token(String Token_Type, String Content_Type, String Subscription_State, String Plan, String Role1, String SHaccount1, String SHaccount2, String Ownership, String Role2, String Status_Code, String Schema) throws ParseException {
        ...
        logs.test_step("------------------------------------------ POST THE SMTP IMAP TEST CONNECTION ROLE1 --------------------------------------------");
        String update_file = builder.updateRequestObject("email_account/smtp_imap_connection/smtp_imap_connection_with_valid_token", pathParameter, queryParameters, header, body);
        ...
        logs.test_step("------------------------------------------ POST THE SMTP IMAP TEST CONNECTION ROLE2--------------------------------------------");
        String update_file_role_2 = builder.updateRequestObject("email_account/smtp_imap_connection/smtp_imap_connection_with_valid_token", pathParameter1, queryParameters1, header1, body1);
    ...
    public Object[][] data_provider2() {
        DataReader reader = new DataReader();
        Object[][] data = null;
        data = reader.getExcelDataForDataProvider("Smtp_Imap_Connection_Test_case.xlsx", 2);
        return data;
    }
...
validator.validateSchema(Schema);}
    ...
    public Object[][] data_provider3() {
        DataReader reader = new DataReader();
        Object[][] data = null;
        data = reader.getExcelDataForDataProvider("Smtp_Imap_Connection_Test_case.xlsx", 3);
        return data;
    }
...
validator.validateSchema(Schema);}
    ...
    public Object[][] data_provider4() {
        DataReader reader = new DataReader();
        Object[][] data = null;
        data = reader.getExcelDataForDataProvider("Smtp_Imap_Connection_Test_case.xlsx", 4);
        return data;
    }
...
validator.validateSchema(Schema);}
    ...
    @Test
    public void smtp_imap_with_different_content_type() {
    ...
    @Test
    public void smtp_imap_with_different_method_name() {
        ...
        String update_file = builder.updateRequestObject("email_account/smtp_imap_connection/smtp_imap_connection_with_different_method", pathParameter, queryParameters, header, body);
        JSONObject response = builder.performRequest(update_file);
        ResponseValidator validator = new ResponseValidator(response);
