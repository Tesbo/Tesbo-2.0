...
public class providerChangeStatus extends base {
    ...
    public void providerChangeStatus_for_Admin_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
        ...
        body.put("to_status_id","1");
        JSONObject pathParameter = new JSONObject();
        JSONObject queryParameters = new JSONObject();
        queryParameters.put("organization_provider_ids","23029");
        queryParameters.put("organization_id",organizationId.substring(0,3));
        JSONObject schema = new JSONObject();

        String update_file = builder.updateRequestObject("CSPanelAPI/providerChangeStatus", pathParameter, queryParameters, header, body, schema);
        ...
        assertThat(message).contains("employees moved to Active");
    ...
    public void providerChangeStatus_Manager_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerChangeStatus_Coordinator_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerChangeStatus_Coordinator_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerChangeStatus_RN_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerChangeStatus_RN_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerChangeStatus_Viewer_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    @Test(dataProvider = "login_email_password_Admin")
    public void providerChangeStatus_without_status_change(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
        ...
        String update_file = builder.updateRequestObject("CSPanelAPI/providerChangeStatusWithoutStatus", pathParameter, queryParameters, header, body, schema);
        JSONObject response = builder.performRequest(update_file);
        System.out.println(response);
        ...
        String message = validator.getDataFromBody("$.message");
        assertThat(message).isEqualTo("Provider Status not found");
