...
public class createUserFilter extends base {
    ...
    public void createUserFilter_for_Admin_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
        ...
        String update_file = builder.updateRequestObject("CSPanelAPI/createUserFilter", pathParameter, queryParameters, header, body, schema);
        ...
        assertThat(message).isEqualTo("User filter created successfully");
    ...
    public void createUserFilter_Manager_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void createUserFilter_Coordinator_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void createUserFilter_Coordinator_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void createUserFilter_RN_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void createUserFilter_RN_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void createUserFilter_Viewer_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    @Test(dataProvider = "login_email_password_Admin")
    public void createUserFilter_with_wrong_organizationID(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
