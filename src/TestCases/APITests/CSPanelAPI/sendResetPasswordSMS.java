...
public class sendResetPasswordSMS extends base {
    ...
    public void sendResetPasswordSMS_for_Admin_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
        ...
        queryParameters.put("type","provider");
        queryParameters.put("sms","1");
        JSONObject schema = new JSONObject();

        String update_file = builder.updateRequestObject("CSPanelAPI/sendResetPasswordSMS", pathParameter, queryParameters, header, body, schema);
        ...
        assertThat(message).isEqualTo("SMS sent");
    ...
    public void sendResetPasswordSMS_Manager_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void sendResetPasswordSMS_Coordinator_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void sendResetPasswordSMS_Coordinator_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void sendResetPasswordSMS_RN_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void sendResetPasswordSMS_RN_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void sendResetPasswordSMS_Viewer_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
