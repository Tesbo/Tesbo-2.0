...
public class providerHistory extends base {
    ...
    public void providerHistory_for_Admin_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
        ...
        String update_file = builder.updateRequestObject("CSPanelAPI/providerHistory", pathParameter, queryParameters, header, body, schema);
    ...
    public void providerHistory_Manager_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerHistory_Coordinator_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerHistory_Coordinator_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerHistory_RN_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerHistory_RN_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerHistory_Viewer_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    @Test(dataProvider = "login_email_password_Viewer")
    public void providerHistory_negative_case_without_organizationId(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
        ...
        String update_file = builder.updateRequestObject("CSPanelAPI/providerHistoryNegativeCase", pathParameter, queryParameters, header, body, schema);
        JSONObject response = builder.performRequest(update_file);
        System.out.println(response);
