...
public class providerListWithFormatField extends base {
    ...
    public void providerListWithFormatField_for_Admin_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
        ...
        queryParameters.put("export","1");
        queryParameters.put("include_expired","1");
        queryParameters.put("per_page","50");
        queryParameters.put("format","csv");
        queryParameters.put("organization_id",organizationId);
        JSONObject schema = new JSONObject();

        String update_file = builder.updateRequestObject("CSPanelAPI/providerListWithFormatField", pathParameter, queryParameters, header, body, schema);
        ...
        String url = validator.getDataFromBody("$.url");
        assertThat(url).containsAnyOf("downloads/exports");
        assertThat(url).containsAnyOf("csv");
    ...
    public void providerListWithFormatField_Manager_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
        RequestBuilder builder = new RequestBuilder();
        GetTokenUtility getToken = new GetTokenUtility();
    ...
    public void providerListWithFormatField_Coordinator_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
        RequestBuilder builder = new RequestBuilder();
        GetTokenUtility getToken = new GetTokenUtility();
    ...
    public void providerListWithFormatField_Coordinator_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerListWithFormatField_RN_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerListWithFormatField_RN_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void providerListWithFormatField_Viewer_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
