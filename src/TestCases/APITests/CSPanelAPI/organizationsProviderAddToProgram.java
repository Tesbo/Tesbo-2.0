...
public class organizationsProviderAddToProgram extends base {
    ...
    public void organizationProviderAddToProgram_for_Admin_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
        ...
        queryParameters.put("organization_provider_ids",organization_provider_ids.substring(0,3));
        JSONObject schema = new JSONObject();

        String update_file = builder.updateRequestObject("CSPanelAPI/organizationProviderAddToProgram", pathParameter, queryParameters, header, body, schema);
    ...
    public void organizationProviderAddToProgram_Manager_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void organizationProviderAddToProgram_Coordinator_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void organizationProviderAddToProgram_Coordinator_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void organizationProviderAddToProgram_RN_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void organizationProviderAddToProgram_RN_Limited_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
    ...
    public void organizationProviderAddToProgram_Viewer_User(String email, String password, String organizationId, String organizationName,String organization_provider_ids, String course_id) {
