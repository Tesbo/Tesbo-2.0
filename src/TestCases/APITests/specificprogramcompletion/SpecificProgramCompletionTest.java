package TestCases.APITests.specificprogramcompletion;
...
public class SpecificProgramCompletionTest extends base {
    @Test
    public void verify_specific_program_completion_with_valid_token (){
        ...
        String  update_file = builder.updateRequestObject("specificprogramcompletion/specific_program_completion_with_valid_token",pathParameter, queryParameters, header, body,body1);
        ...
        String startdate_ex = specificprogramcompletion_validator.getDataFromBody("$.data[*].start_date");
        assertThat(startdate_ex).isNotBlank();

        String duedate_ex = specificprogramcompletion_validator.getDataFromBody("$.data[*].due_date");
        assertThat(duedate_ex).isNotBlank();

        String employeeid_ex = specificprogramcompletion_validator.getDataFromBody("$.data[*].employee_id");
        assertThat(employeeid_ex).isNotBlank();

        String programeid_ex = specificprogramcompletion_validator.getDataFromBody("$.data[*].program_id");
        assertThat(programeid_ex).isNotBlank();

        String status_ex = specificprogramcompletion_validator.getDataFromBody("$.data[*].status");
        assertThat(status_ex).isNotBlank();

        String completeddatetime_ex = specificprogramcompletion_validator.getDataFromBody("$.data[*].completed_datetime");
        assertThat(completeddatetime_ex).isNotBlank();

        String approvaldatetime_ex = specificprogramcompletion_validator.getDataFromBody("$.data[*].approval_datetime");
        assertThat(approvaldatetime_ex).isNotBlank();
    }
    @Test
    public void verify_specific_program_completion_with_blank_token () {
        RequestBuilder builder = new RequestBuilder();

        JSONObject response = builder.performRequest("specificprogramcompletion/specific_program_completion_with_valid_token");
    ...
    @Test
    public void verify_specific_program_completion_with_invalid_token() {
        RequestBuilder builder = new RequestBuilder();
        ...
        String  update_file = builder.updateRequestObject("specificprogramcompletion/specific_program_completion_with_invalid_token",pathParameter, queryParameters, header, body,body);
